...
def FormErrors(*args):
    '''
    handle form error that are back from Ajax calls
    '''
    message=""
    for f in args:
        if f.errors:
...
def reCAPTCHAValidation(token):
    ...
    result=requests.post(
        'https://www.google.com/recaptchar/api/siteverify',
        data={
...
class AjaxFormMixin(object):
    '''
    Mixin to ajaxify form can be overwritten in view by calling
    form_valid method
    '''
